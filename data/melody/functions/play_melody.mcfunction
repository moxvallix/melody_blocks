...
execute if entity @s[scores={melody_row=17}] run tag @s remove playing
execute if entity @s[scores={melody_row=17},tag=!playing] run scoreboard players set @s melody_row 0
